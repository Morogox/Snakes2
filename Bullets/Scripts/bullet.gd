...
var life_timer := 0.0
@export var damage: float = 0.0       # placeholder, will be set by gun
...
var impact_data = {
	"player_1": {
		"sprite": preload("res://Particles/Sprites/sBullet1_impact.png"),
	...
	"enemy_1": {
		...
		"particle": preload("res://Particles/Scenes/enemy_bullet1_spark.tscn"),
		"lifetime": 0.3,
		"scale": 2.0,
		"lock_rotation": true
	},
